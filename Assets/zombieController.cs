...
public class zombieController : MonoBehaviour
{
    ...
    public float detectionRange = 5f; // Distance within which the zombie detects the player
    ...
    [SerializeField] Rigidbody2D rb; // Rigidbody component of the zombie
    ...
    void Update()
    {
        ...
        if (actionTimer >= actionInterval && distanceToPlayer < detectionRange)
        {
            // Reset the timer
            actionTimer = 0f;
